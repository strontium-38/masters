...
\begin{figure}
    ...
    \begin{subfigure}[t]{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth]{assets/reator-19-5.jpg}
    ...
    \begin{subfigure}[t]{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth]{assets/reator-22-5.jpg}
...
\begin{figure}
    ...
    \begin{subfigure}[t]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{assets/reator-limp-seco-24-8.jpg}
    ...
    \begin{subfigure}[t]{0.45\textwidth}
        \centering
        \includegraphics[width=0.8\textwidth]{assets/reator-limp-agua-24-8.jpg}
...
\begin{figure}[H]
    ...
    \VolumeGraphInt[xtick distance=10, minor xtick={1,2,...,97}]
        {experimentos-day.csv}{0}{97}{Day}{Volume (\unit{\normalized\milli\litre})}{}
...
\begin{figure}[H]
    ...
    \FlowGraph[xtick distance=10, minor xtick={1,2,...,97}]
        {experimentos-day.csv}{0}{97}{Day}{Flow (\unit{\normalized\milli\litre\per\day})}{}
    \caption{Source: Author}
...
\begin{figure}[H]
    \centering
    \VolumeGraphInt[xtick distance=10, minor xtick={1,2,...,97}]
        {experimentos-day.csv}{0}{24}{Day}{Volume (\unit{\normalized\milli\litre})}{}
    \caption{Source: Author}
...
\begin{figure}[H]
    \centering
    \FlowGraph[xtick distance=10, minor xtick={1,2,...,97}]
        {experimentos-day.csv}{0}{24}{Day}{Flow (\unit{\normalized\milli\litre\per\day})}{}
    \caption{Source: Author}
...
\begin{figure}[H]
    \centering
    \VolumeGraphInt[xtick distance=10, minor xtick={1,2,...,97}]
        {experimentos-day.csv}{25}{52}{Day}{Volume (\unit{\normalized\milli\litre})}{}
    \caption{Source: Author}
...
\begin{figure}[H]
    \centering
    \FlowGraph[xtick distance=10, minor xtick={1,2,...,97}]
        {experimentos-day.csv}{25}{52}{Day}{Flow (\unit{\normalized\milli\litre\per\day})}{}
    \caption{Source: Author}
    \label{graph:ra-flow}
\end{figure}
...
\begin{figure}[H]
    ...
    \FlowGraph[xtick distance=100, minor xtick={1,2,...,97}]
        {experimentos-30min.csv}{600}{1248.75}{Hour}{Flow (\unit{\normalized\milli\litre\per\day})}{}
    \caption{Source: Author}
...
\begin{figure}[H]
    \centering
    \VolumeGraphInt[xtick distance=10, minor xtick={1,2,...,97}]
        {experimentos-day.csv}{53}{81}{Day}{Volume (\unit{\normalized\milli\litre})}{}
    \caption{Source: Author}
...
\begin{figure}[H]
    \centering
    \FlowGraph[xtick distance=10, minor xtick={1,2,...,97}]
        {experimentos-day.csv}{53}{81}{Day}{Flow (\unit{\normalized\milli\litre\per\day})}{}
    \caption{Source: Author}
    \label{graph:gl-flow}
\end{figure}
...
\begin{figure}[H]
    \centering
    \FlowGraph[xtick distance=100, minor xtick={1,2,...,97}]
        {experimentos-30min.csv}{1272}{1941.5}{Hour}{Flow (\unit{\normalized\milli\litre\per\day})}{}
    \caption{Source: Author}
...
\begin{figure}[H]
    \centering
    \VolumeGraphInt[xtick distance=10, minor xtick={1,2,...,97}]
        {experimentos-day.csv}{82}{97}{Day}{Volume (\unit{\normalized\milli\litre})}{}
    \caption{Source: Author}
...
\begin{figure}[H]
    \centering
    \FlowGraph[xtick distance=10, minor xtick={1,2,...,97}]
        {experimentos-day.csv}{82}{97}{Day}{Flow (\unit{\normalized\milli\litre\per\day})}{}
    \caption{Source: Author}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \begin{axis}[
            ...
            ylabel={VFA (\unit{\milli\gram\ce{CH3COOH}\per\litre})},
...
\begin{figure}[H]
    \centering
    \begingroup
    \pgfplotstableread[col sep=comma]{ph-ratio.csv}{\datatable}
    \begin{tikzpicture}
        \begin{axis}[
            width=15cm, height=10cm,
            xlabel={Time (\unit{\day})},
